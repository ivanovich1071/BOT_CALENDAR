...
STAFF_LINKED = "✅ Готово. Уведомления о записях к специалисту «{name}» будут приходить сюда."
STAFF_LINK_EXPIRED = "Ссылка устарела или уже использована. Попросите администратора создать новую."
...
AI_FAILED = "Не получилось ответить — попробуйте ещё раз чуть позже или воспользуйтесь кнопками 👇"
...
AI_PROPOSAL_EXPIRED = "Это предложение устарело. Напишите, что подобрать, или нажмите «Записаться» в меню."
AI_OTHER_DAY = "Выберите другую дату — {employee}, {service}:"
BTN_AI_BOOK = "✅ Записаться"
BTN_AI_OTHER = "🗓 Другое время"
